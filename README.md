...
The screenshots above and the packaged frames are nuScenes-derived imagery — see
[Dataset attribution & license](#dataset-attribution--license).
...
| Demo 1-9a ✅ | Public demo | Self-contained Streamlit app (`app/demo/`) over a committed 25 MB artifact package: six story pages, every number derived at build time, recorded chat replay, deployable to Streamlit Community Cloud — see [DEMO.md](docs/DEMO.md) |
